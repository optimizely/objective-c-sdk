...
@implementation OPTLYiOSManagerBuilder

+ (nullable instancetype)builderWithBlock:(OPTLYiOSManagerBuilderBlock)block {
...
- (id)initWithBlock:(OPTLYiOSManagerBuilderBlock)block {
