...
{
    NSData *jsonData = [OPJMModelTestHelper dataForResource:name ofType:ext];
...
{
    NSData *jsonData = [OPJMModelTestHelper dataForResource:@"primitivesWithErrors" ofType:@"json"];
...
{
    NSData *jsonData = [OPJMModelTestHelper dataForResource:@"nestedDataWithTypeMismatchOnImages" ofType:@"json"];
