...
-(void)setUp
{
    ...
    jsonContents = [OPJMModelTestHelper stringForResource:@"jsonTypes" ofType:@"json"];
}
...
-(void)testInvalidData
{
	...
	NSAssert(err.code == kOPJMModelErrorModelIsInvalid, @"Error code is not kOPJMModelErrorModelIsInvalid");
