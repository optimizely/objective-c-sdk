...
{
	return [[OPJMKeyMapper alloc] initWithDictionary:@
	{
		@"texts.text1": @"text1",
...
@interface AtNameModel : OPJMModel
...
@interface GlobalModel: OPJMModel
...
-(void)setUp
{
    ...
    NSData *jsonData = [OPJMModelTestHelper dataForResource:@"github-iphone" ofType:@"json"];
...
-(void)testGlobalKeyMapperImportAndExport
{
	...
	[OPJMModel setGlobalKeyMapper:[[OPJMKeyMapper alloc] initWithDictionary:@{
		@"name1":@"name"
	 }]];
	...
	[OPJMModel setGlobalKeyMapper:nil];
...
//https://github.com/opjmmodel/opjmmodel/issues/132
...
{
    NSString* jsonContents = [OPJMModelTestHelper stringForResource:@"nestedDataWithArrayError" ofType:@"json"];
...
//https://github.com/opjmmodel/opjmmodel/issues/180
