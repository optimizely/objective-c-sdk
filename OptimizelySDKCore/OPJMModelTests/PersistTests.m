...
-(void)testPersistJSONTypes
{
    ...
    NSString* jsonContents = [OPJMModelTestHelper stringForResource:@"jsonTypes" ofType:@"json"];
...
-(void)testBoolExport
{
    ...
    NSString* jsonContents = [OPJMModelTestHelper stringForResource:@"converts" ofType:@"json"];
