...
- (void)testBuildEventTicketWithEventMultipleExperiments
{
    ...
    // TODO - Change assertion to subtract 3 when this bug is fixed: MBL-3171; 6450630664 should be exlucded becuase it is mutually excluded.
    NSAssert(numberOfLayers == (numberOfExperiments - 2), @"Incorrect number of layers.");
}
