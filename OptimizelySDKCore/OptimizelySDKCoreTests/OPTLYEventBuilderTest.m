...
- (void)checkTicket:(Ticket)ticket
    ...
    XCTAssertGreaterThan([visitors count], 0, @"");
    ...
    for (NSDictionary *visitor in visitors) {
        ...
        XCTAssertGreaterThan([conversionOrImpressionOnlyParams count], 0, @"");
...
- (void)checkImpressionTicket:(NSDictionary *)params
    ...
    XCTAssertGreaterThan([decisions count], 0, @"");
    XCTAssertGreaterThan([experimentKeys count], 0, @"");
...
- (void)checkImpression:(NSDictionary *)params
    ...
    // TODO:
    XCTAssert([uuid isEqualToString: @""], @"Invalid uuid.");
