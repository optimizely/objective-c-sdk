...
NSString *const OPTLYLoggerMessagesRevenueValueInvalidInteger = @"[EVENT BUILDER] Provided revenue value is an invalid integer type and will be cast to the integer: %lld.";
NSString *const OPTLYLoggerMessagesRevenueValueString = @"[EVENT BUILDER] Provided revenue value is a string and will be cast to the integer: %lld.";
...
NSString *const OPTLYLoggerMessagesNumericValueInvalidDouble = @"[EVENT BUILDER] Provided numeric value is an invalid double type and will be cast to the double: %g.";
NSString *const OPTLYLoggerMessagesNumericValueString = @"[EVENT BUILDER] Provided numeric value is a string and will be cast to the double: %g.";
