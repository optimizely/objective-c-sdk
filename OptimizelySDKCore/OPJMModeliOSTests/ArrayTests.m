...
-(void)setUp
{
    ...
    NSString* jsonContents = [OPJMModelTestHelper stringForResource:@"github-iphone" ofType:@"json"];
...
/*
 * https://github.com/opjmmodel/opjmmodel/pull/14
 */
...
/*
 * https://github.com/opjmmodel/opjmmodel/issues/15
 */
