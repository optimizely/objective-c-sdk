...
{
    NSString* jsonContents = [OPJMModelTestHelper stringForResource:@"withOptProp" ofType:@"json"];
...
{
    NSString* jsonContents = [OPJMModelTestHelper stringForResource:@"withoutOptProp" ofType:@"json"];
