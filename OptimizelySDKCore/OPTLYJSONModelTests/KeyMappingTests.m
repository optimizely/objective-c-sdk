...
{
	return [[OPTLYJSONKeyMapper alloc] initWithDictionary:@
	{
		@"texts.text1": @"text1",
...
@interface AtNameModel : OPTLYJSONModel
...
@interface GlobalModel: OPTLYJSONModel
...
-(void)testGlobalKeyMapperImportAndExport
{
	...
	[OPTLYJSONModel setGlobalKeyMapper:[[OPTLYJSONKeyMapper alloc] initWithDictionary:@{
		@"name1":@"name"
	 }]];
	...
	[OPTLYJSONModel setGlobalKeyMapper:nil];
...
//https://github.com/optlyjsonmodel/optlyjsonmodel/issues/132
...
{
    NSString* jsonContents = [OPTLYJSONModelTestHelper stringForResource:@"nestedDataWithArrayError" ofType:@"json"];
...
//https://github.com/optlyjsonmodel/optlyjsonmodel/issues/180
