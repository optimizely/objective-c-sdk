Pod::Spec.new do |s|
  ...
  s.dependency 'OptimizelySDKEventDispatcher', '0.5.0-alpha1'
  s.dependency 'OptimizelySDKUserProfile', '0.5.0-alpha1'
  s.dependency 'OptimizelySDKDatafileManager', '0.5.0-alpha1'
end
