Pod::Spec.new do |s|
  ...
  s.dependency 'OptimizelySDKEventDispatcher', "3.0.3-alpha"
  s.dependency 'OptimizelySDKUserProfileService', "3.0.3-alpha"
  s.dependency 'OptimizelySDKDatafileManager', "3.0.3-alpha"
end
