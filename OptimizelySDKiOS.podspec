Pod::Spec.new do |s|
  ...
  s.dependency 'OptimizelySDKEventDispatcher', '0.2.1-alpha3'
  s.dependency 'OptimizelySDKUserProfile', '0.2.1-alpha3'
  s.dependency 'OptimizelySDKDatafileManager', '0.2.1-alpha3'
end
