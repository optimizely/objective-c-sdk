Pod::Spec.new do |s|
  ...
  s.dependency 'OptimizelySDKEventDispatcher', '0.2.1-alpha4'
  s.dependency 'OptimizelySDKUserProfile', '0.2.1-alpha4'
  s.dependency 'OptimizelySDKDatafileManager', '0.2.1-alpha4'
end
