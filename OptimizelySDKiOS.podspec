Pod::Spec.new do |s|
  ...
  s.dependency 'OptimizelySDKEventDispatcher', '2.0.2-beta4'
  s.dependency 'OptimizelySDKUserProfileService', '2.0.2-beta4'
  s.dependency 'OptimizelySDKDatafileManager', '2.0.2-beta4'
end
