Pod::Spec.new do |s|
  ...
  s.dependency 'OptimizelySDKEventDispatcher', '0.4.0-alpha3'
  s.dependency 'OptimizelySDKUserProfile', '0.4.0-alpha3'
  s.dependency 'OptimizelySDKDatafileManager', '0.4.0-alpha3'
end
