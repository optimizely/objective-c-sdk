...
#define LOCALYTICS_LIBRARY_VERSION      @"4.4.1" //iOS version
...
/** Set an Inbox campaign as read. Read state can be used to display opened but not disabled Inbox
 ...
 @deprecated This method is deprecated. Use 'setInboxCampaign:asRead:' instead.
 */
+ (void)setInboxCampaignId:(NSInteger)campaignId asRead:(BOOL)read __attribute__((deprecated("This method is deprecated. Use 'setInboxCampaign:asRead:' instead.")));
