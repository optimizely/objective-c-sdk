...
#define LOCALYTICS_LIBRARY_VERSION      @"4.3.0" //iOS version
...
/**
 * A standard event to tag an In-App conversion
 *
 * @param campaign    The In-App campaign for which to tag a conversion event
 */
+ (void)tagInAppConversionEventForCampaign:(nonnull LLInAppCampaign *)campaign;

/**
 * A standard event to tag an In-App conversion
 *
 * @param campaign    The In-App campaign for which to tag a conversion event
 * @param action      The conversion event to tag for the conversion.  If nil, the default value of 'click' will be used.
 */
+ (void)tagInAppConversionEventForCampaign:(nonnull LLInAppCampaign *)campaign withAction:(nullable NSString *)action;

/**
 * A standard event to tag an In-App dismissal
 *
 * @param campaign    The In-App campaign for which to tag a dismiss event
 */
+ (void)tagInAppDismissEventForCampaign:(nonnull LLInAppCampaign *)campaign;
...
/**
 * A standard event to tag an inbox conversion
 *
 * @param campaign    The inbox campaign for which to tag a conversion event
 */

+ (void)tagInboxConversionEventForCampaign:(nonnull LLInboxCampaign *)campaign;
...
+ (void)tagInboxConversionEventForCampaign:(nonnull LLInboxCampaign *)campaign withAction:(nullable NSString *)action;

/**
 * A standard event to tag an inbox dismissal
 *
 * @param campaign The inbox campaign for which to tag a dismiss event
 */

+ (void)tagInboxDismissEventForCampaign:(nonnull LLInboxCampaign *)campaign;
 ...
 *
 * @param campaign The Places campaign id and region id for which to trigger a notification
 */
